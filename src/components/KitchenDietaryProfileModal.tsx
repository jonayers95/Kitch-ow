...
export type KitchenProfileTab = 'dietary' | 'appliances' | 'dislikes' | 'servings';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-stone-900/60 backdrop-blur-sm animate-in fade-in duration-200">
      ...
      >
        ...
        {/* Navigation Tabs */}
        <div className="border-b border-stone-200 dark:border-stone-800 px-4 sm:px-6 pt-3 bg-stone-50/90 dark:bg-stone-950/60">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 pb-3">
            ...
            <button
              ...
              className={cn(
                'flex items-center justify-center gap-2 py-2.5 px-3 rounded-2xl text-xs sm:text-sm font-semibold transition-all border shadow-xs',
                activeTab === 'dietary'
            ...
            >
              ...
              <span className="truncate">Dietary & Allergies</span>
              {totalDietaryCount > 0 && (
                <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-emerald-200/70 dark:bg-emerald-900 text-emerald-900 dark:text-emerald-200 font-bold shrink-0">
                  {totalDietaryCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              <span className="truncate">Kitchen Appliances</span>
              {totalApplianceCount > 0 && (
                <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-amber-200/70 dark:bg-amber-900 text-amber-900 dark:text-amber-200 font-bold shrink-0">
                  {totalApplianceCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              <span className="truncate">Avoid Ingredients</span>
              {totalDislikeCount > 0 && (
                <span className="text-[11px] px-1.5 py-0.5 rounded-full bg-rose-200/70 dark:bg-rose-900 text-rose-900 dark:text-rose-200 font-bold shrink-0">
                  {totalDislikeCount}
                </span>
              )}
            </button>
            ...
            >
              ...
              <span className="truncate">Servings & Notes</span>
            </button>
          </div>

          {/* Quick Selected Overview bar */}
          <div className="flex flex-wrap items-center gap-1.5 pb-3 pt-1 text-xs border-t border-stone-200/60 dark:border-stone-800/60">
            ...
            >
              <span>🌱</span>
              <span>{totalDietaryCount > 0 ? `${totalDietaryCount} Diet Rule${totalDietaryCount > 1 ? 's' : ''}` : 'No Diet Rules (Set)'}</span>
            </button>
            ...
            >
              <span>⚡</span>
              <span>{totalApplianceCount > 0 ? `${totalApplianceCount} Appliance${totalApplianceCount > 1 ? 's' : ''}` : 'No Gear (Set)'}</span>
            </button>
            ...
            >
              <span>🚫</span>
              <span>{totalDislikeCount > 0 ? `${totalDislikeCount} Avoided` : 'No Dislikes (Set)'}</span>
            </button>
          </div>
        </div>
                ...
                {COMMON_APPLIANCES.map((appliance) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'p-3 rounded-2xl border text-left transition-all relative flex flex-col justify-between group',
                        isSelected
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold text-xs sm:text-sm">{appliance.label}</span>
                        </div>
                        <div
                          className={cn(
                            'w-5 h-5 rounded-full flex items-center justify-center border text-[10px] shrink-0 transition-colors',
                            isSelected
                    ...
                    >
                      <div className="flex items-start justify-between gap-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-semibold text-xs sm:text-sm">{diet.label}</span>
                        </div>
                        <div
                          className={cn(
                            'w-5 h-5 rounded-full flex items-center justify-center border text-[10px] shrink-0 transition-colors',
                ...
                {COMMON_DISLIKES.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        'p-2.5 rounded-2xl border text-left transition-all relative flex items-center justify-between gap-2 group',
                        isSelected
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          'w-4 h-4 rounded-full flex items-center justify-center border text-[9px] shrink-0 transition-colors',
                          isSelected
            ...
            <div className="space-y-6 animate-in fade-in duration-200">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={cn(
                        'p-4 rounded-2xl border text-center transition-all flex flex-col items-center justify-center',
                    ...
                    >
                      <span className="text-xl font-bold font-serif">{tier.value}</span>
                      <span className="text-xs font-semibold mt-1">{tier.label}</span>
                      <span className="text-[10px] text-stone-400 mt-0.5">{tier.desc}</span>
                    </button>
                  ))}
                </div>
              </div>
              ...
              <div className="space-y-2 pt-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-2xl border border-stone-200 dark:border-stone-700 bg-white dark:bg-stone-800 text-stone-900 dark:text-stone-100 placeholder:text-stone-400 focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 outline-none text-sm transition-all resize-none"
                />
              </div>
            </div>
          )}
        ...
        <div className="p-4 sm:p-6 border-t border-stone-200 dark:border-stone-800 bg-white dark:bg-stone-900/90 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-2 text-xs text-stone-500 dark:text-stone-400">
            <span className="font-semibold text-stone-800 dark:text-stone-200">Active Profile:</span>
            <span className="px-2 py-0.5 rounded-full bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-300 border border-emerald-200/50">
              🌱 {totalDietaryCount} dietary
            </span>
            <span className="px-2 py-0.5 rounded-full bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 border border-amber-200/50">
              ⚡ {totalApplianceCount} appliances
            </span>
            <span className="px-2 py-0.5 rounded-full bg-rose-50 dark:bg-rose-950/40 text-rose-700 dark:text-rose-300 border border-rose-200/50">
              🚫 {totalDislikeCount} avoided
            </span>
          </div>
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            <button
              ...
              onClick={handleSave}
              disabled={isSaving}
              className="px-6 py-2.5 rounded-xl bg-stone-900 dark:bg-stone-100 text-white dark:text-stone-900 hover:bg-stone-800 dark:hover:bg-white text-xs font-bold transition-all shadow-md active:scale-95 flex items-center gap-2 disabled:opacity-50"
            >
              {isSaving ? (
                <>
